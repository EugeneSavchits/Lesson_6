...
public class CSSSelector {
    ...
    private void cssSelector () {
        ...
        By tagAttributSelector = By.cssSelector("label[for]"); // поиск по tag и атрибуту без значением
        ...
        By fullHierarchicalSelector = By.cssSelector("body .table .content-inner"); // поиск c начала простого дочернего элемента

        By searchLikeContainsSelector = By.cssSelector("for[action*='admin']"); // поиск c вхождением подстроки в значении атрибута
        By searchBYWordSelector = By.cssSelector("for[action~='admin']"); // поиск c вхождением слова в значении атрибута
        ...
        By childAfterParentsSelector = By.cssSelector("ul>li"); // поиск дочернего li у которого родитель ul
        ...
        By firstChildSelector = By.cssSelector("li:first-child"); //поиск первого дочерненго элемента
        By lastChildSelector = By.cssSelector("li:first-child"); //поиск последнего дочерненго элемента

        By nthChildFromBeginSelector = By.cssSelector("li:nth-child(2)"); // поиск эннего дочернего элемента c начала
        By nthlastChildSelector = By.cssSelector("li:nth-last-child(3)"); // поиск эннего дочернего элемента с конца
